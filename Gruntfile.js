...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
		...
		patterns: {
          ...
          html: [
              [/(images\/.*?\.(?:gif|jpeg|jpg|png|webp|svg))/gm, 'Update the JS to reference our revved images'],
			    [/(scripts\/.*?\.(?:js))/gm, 'Update the JS to reference our revved images'],
				  [/(styles\/.*?\.(?:css))/gm, 'Update the JS to reference our revved images']
          ]
      }
      }
    },
    ...
    replace: {
    	replacePath: {
            src: ['<%= yeoman.dist %>/scripts/scripts*.js','<%= yeoman.dist %>/**/*.html'],
            overwrite: true,
            replacements: [
    		  {
                from: 'data/',
                to: '<%= yeoman.deployPath %>data/'
              },
    		  {
                from: 'views/',
                to: '<%= yeoman.deployPath %>views/'
              },
              {
                from: 'scripts/',
                to: '<%= yeoman.deployPath %>scripts/'
              },
    		  {
                from: 'styles/',
                to: '<%= yeoman.deployPath %>styles/'
              },
    		  {
                from: 'images/',
                to: '<%= yeoman.deployPath %>images/'
              },
    		  {
                from: 'bower_components/',
                to: '<%= yeoman.deployPath %>bower_components/'
              },
    		  {
                from: 'resources/',
                to: '<%= yeoman.deployPath %>resources/'
              }
            ]
          },
